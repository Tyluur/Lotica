...
public class MusicHints {
	...
	private final static String PACKED_PATH = "data/resource/world/musics/packedMusicHints.mh";
	private final static String UNPACKED_PATH = "data/resource/world/musics/unpackedMusicHints.txt";
	...
	private static void loadUnpackedItemExamines() {
		System.out.println("Packing music hints...");
		try {
