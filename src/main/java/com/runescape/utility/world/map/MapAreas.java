...
public final class MapAreas {
	...
	private final static String PACKED_PATH = "data/resource/world/map/packedMapAreas.ma";
	...
	private static void loadUnpackedMapAreas() {
		...
		try {
			BufferedReader in = new BufferedReader(new FileReader("data/resource/world/map/unpackedMapAreas.txt"));
