...
import com.runescape.game.world.entity.player.DominionTower;
...
public final class DTRank implements Serializable {
	...
	private static final String PATH = GameConstants.HOSTED ? GameConstants.LINUX_HOST ? "/root/gamedata/dt_rankings.ser" : "C:/gamedata/dt_rankings.ser" : "data/resource/dtRanks.ser";
