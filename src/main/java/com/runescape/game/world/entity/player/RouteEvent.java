...
public class RouteEvent {
     ...
     *
     * @param target The target we're travelling to
     * @param task   The {@code Runnable} task to execute
     */
     ...
     * @param state  The state, used only for floor items, to make pickup smoother
     */
    public boolean processEvent(Player player, int state) {
        if (player.getPlane() != destinationTile.getPlane()) {
            return true;
        }
