...
public final class QueenBlackDragon extends NPC {
	 ...
	 */
	private static final QueenAttack[] PHASE_1_ATTACKS = { new FireBreathAttack(),
	                                                       new MeleeAttack(),
	                                                       new RangeAttack(),
	                                                       new FireWallAttack() };
	 ...
	 */
	private static final QueenAttack[] PHASE_2_ATTACKS = { new FireBreathAttack(),
	                                                       new MeleeAttack(),
	                                                       new RangeAttack(),
	                                                       new FireWallAttack(),
	                                                       new ChangeArmour(),
	 ...
	 */
	private static final QueenAttack[] PHASE_3_ATTACKS = { new FireBreathAttack(),
	                                                       new MeleeAttack(),
	                                                       new RangeAttack(),
	                                                       new FireWallAttack(),
	                                                       new ChangeArmour(),
	...
	public void setPhase(int phase) {
		...
		switch (phase) {
			...
			case 5:
				setCantInteract(true);
				souls.forEach(TorturedSoul::finish);
				worms.forEach(NPC::finish);
				ticks = -22;
				prepareRewards();
