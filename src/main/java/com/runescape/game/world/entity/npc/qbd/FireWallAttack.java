...
public final class FireWallAttack implements QueenAttack {
	...
	public int attack(final QueenBlackDragon npc, final Player victim) {
		...
		npc.getAttributes().put("fire_wall_tick_", npc.getTicks() + Utils.random((waves * 7) + 5, 60)); //Don't make it too often.
		return 8 + (waves * 2);
	}

	@Override
	public boolean canAttack(QueenBlackDragon npc, Player victim) {
		Integer tick = (Integer) npc.getAttributes().get("fire_wall_tick_");
