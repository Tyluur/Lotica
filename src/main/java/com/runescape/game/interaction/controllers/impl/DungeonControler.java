...
import com.runescape.game.content.skills.dungeoneering.DungeonPartyPlayer;
import com.runescape.game.content.skills.dungeoneering.DungeonUtils;
...
public class DungeonControler extends Controller {
	...
	public void showDeaths() {
		player.getInterfaceManager()
				.sendTab(
						player.getInterfaceManager().onResizable() ? 10
								: 8, 945);
	}
	...
	public boolean processMagicTeleport(WorldTile toTile) {
		return !(dungeon == null || !player.getCombatDefinitions().isDungeoneeringSpellbook() || !dungeon.hasStarted());
	}
