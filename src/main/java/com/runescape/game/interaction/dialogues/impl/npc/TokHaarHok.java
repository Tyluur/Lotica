...
public class TokHaarHok extends Dialogue {
	...
	public void run(int interfaceId, int componentId) {
		...
		case 0: // TODO
			...
			case -1:
				stage = 0;
				sendOptionsDialogue(DEFAULT_OPTIONS, "Let's fight.", "I'd like to speak more about you and your kind.");
				break;
			case 0:
				switch (componentId) {
				case OPTION_1:
			...
			case 1:
				stage = 2;
				sendOptionsDialogue(DEFAULT_OPTIONS, "No, let's just fight.", "What do I get if I beat you?", "What are the rules?");
				break;
			case 2:
				switch (componentId) {
				case OPTION_1:
		...
		case 6:
			...
			case 5:
				if (componentId == OPTION_1) {
					player.getAttributes().put("FightKilnReward", stage == 4 ? 0 : 1);
					stage = 6;
