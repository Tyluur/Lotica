...
import com.runescape.game.world.entity.npc.fightpits.FightPitsNPC;
import com.runescape.game.world.entity.npc.fightpits.TzKekPits;
...
public final class FightPits {
	...
	public static void startGame(boolean end) {
		...
		CoresManager.FAST_EXECUTOR.scheduleAtFixedRate(gameTask, end ? 60000 : 10000, 60000);
