...
public class WeaponPoison {
	...
	public enum Weapon {
		...
		NOVITE_ARROWS(16427, 15958, 15969, 15980),
		BATHUS_ARROWS(16432, 15959, 15970, 15981),
		MARMAROS_ARROWS(16437, 15960, 15971, 15982),
		KRATONITE_ARROWS(16442, 15961, 15972, 15983),
		FRACTITE_ARROWS(16447, 15962, 15973, 15984),
		ZEPHYRIUM_ARROWS(16452, 15963, 15974, 15985),
		ARGONITE_ARROWS(16457, 15964, 15975, 15986),
		KATAGON_ARROWS(16462, 15965, 15976, 15987),
		GORGONITE_ARROWS(16467, 15966, 15977, 15988),
		PROMETHIUM_ARROWS(16472, 15967, 15978, 15989),
		SAGITTARIAN_ARROWS(16477, 15968, 15979, 15990),
		NOVITE_DAGGER(16757, 15849, 15850, 15851),
		BATHUS_DAGGER(16765, 15853, 15854, 15855),
		MARMAROS_DAGGER(16773, 15857, 15858, 15859),
		KRATONITE_DAGGER(16781, 15861, 15862, 15863),
		FRACTITE_DAGGER(16789, 15865, 15866, 15867),
		ZEPHYRIUM_DAGGER(16797, 15869, 15870, 15871),
		ARGONITE_DAGGER(16805, 15873, 15874, 15875),
		KATAGON_DAGGER(16813, 15877, 15878, 15879),
		GORGONITE_DAGGER(16821, 15881, 15882, 15883),
		PROMETHIUM_DAGGER(16829, 15885, 15886, 15887),
		PRIMAL_DAGGER(16837, 15889, 15890, 15891),
		NOVITE_SPEAR(17063, 16219, 16220, 16221),
		BATHUS_SPEAR(17071, 16223, 16224, 16225),
		MARMAROS_SPEAR(17079, 16227, 16228, 16229),
		KRATONITE_SPEAR(17087, 16231, 16232, 16233),
		FRACTITE_SPEAR(17095, 16235, 16236, 16237),
		ZEPHYRIUM_SPEAR(17103, 16239, 16240, 16241),
		ARGONITE_SPEAR(17111, 16243, 16244, 16245),
		KATAGON_SPEAR(17119, 16247, 16248, 16249),
		GORGONITE_SPEAR(17127, 16251, 16252, 16253),
		PROMETHIUM_SPEAR(17135, 16255, 16256, 16257),
		PRIMAL_SPEAR(17143, 16259, 16260, 16261),
