...
public class HouseConstants {
	...
	public enum Builds {
		...
		public boolean containsObject(WorldObject object) {
			for (HObject o : getPieces()) { for (int id : o.getIds()) { if (object.getId() == id) { return true; } } }
			return false;
		}
	...
	public enum POHLocation {
		...
		HOME_PORTAL(new WorldTile(3084, 3492, 0), 1, 5000),
