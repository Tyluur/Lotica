package com.runescape.game.content.skills.cooking;

import com.runescape.game.content.global.minigames.pyramids.PyramidHuntingGame;
...
import com.runescape.game.world.entity.player.achievements.easy.Head_Chef;
...
public class Cooking extends Action {
	...
	public enum Cookables {
		...
		RAW_SALVE_EEL(new Item(17811), 1, 80, 114, new Item(18193), new Item(18173), false, true),
